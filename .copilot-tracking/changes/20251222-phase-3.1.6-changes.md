...
- CurveEditor.sln - Updated app project name/path for MotorEditor.Avalonia.
...
- tests/CurveEditor.Tests/CurveEditor.Tests.csproj - Project reference updated to renamed app project file.
